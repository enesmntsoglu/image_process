function [x, itr] = Lp_solver_depthver2_gpu_2_double_v3_fast(J0, b0, p, lambda0, tol, max_itr, nu, eps0, varargin)
...
%
% x = Lp_solver_depthver2_gpu_2_double_v3_fast(J0, b0, p, lambda0, tol, max_itr, nu, eps0, [x0], [D], [resetGpuAtExit], [stride])
    ...
    if exist('gpuDeviceCount', 'file') ~= 2 || gpuDeviceCount < 1
        error('No GPU device found. Lp_solver_depthver2_gpu_2_double_v3_fast does not allow CPU fallback.');
    end
