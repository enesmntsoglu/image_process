...
outputFolder = 'C:\Users\TUSEB\Desktop\MCXStudio-win64-v2023\MCXStudio\MATLAB\mcxlab\enes\Final_Work_Space\Image_Saver\Images\Test_2\x_ekseni';
if ~exist(outputFolder, 'dir')
    mkdir(outputFolder);
end

% Grid boyutları
grid_size = [1, 10]; % X ve Y çekim sayısı
