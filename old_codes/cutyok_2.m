...
scanX =10; % Tarama noktalarının X eksenindeki sayısı
scanY =10; % Tarama noktalarının Y eksenindeki sayısı
...
image_folder = 'C:\Users\enesm\OneDrive\Desktop\Yeni klasör (2)\21_01_25'; % Görüntülerin olduğu klasör
...
parfor d = 1:size(detector_positions, 1) % Her dedektör için
